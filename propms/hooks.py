...
# JavaScript file includes for specific pages and Doctypes
page_js = {
...
# Fixtures for custom fields and property settings
fixtures = [
    {
...
doc_events = {
    "Issue": {
        "validate": ["propms.issue_hook.validate"],
    },
    "Material Request": {
...
# Installation Events
after_migrate = "propms.install.after_migrate"
